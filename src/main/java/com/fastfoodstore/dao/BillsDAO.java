...
public class BillsDAO implements DAOInterface<BillsDTO> {
    ...
    public int insert(BillsDTO t) {
        ...
        try {
            ...
            String sql = "INSERT INTO `bills` (`billCode`, `date`, `totalNumber`, `totalPrice`,`billStatus`,`location`,`staffCode`)"
                    + " VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            pst.setString(5, t.getBillStatus());
            pst.setString(6, t.getLocation());
            pst.setString(7, t.getStaffId());
