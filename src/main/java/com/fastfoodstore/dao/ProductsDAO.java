...
public class ProductsDAO implements DAOInterface<ProductsDTO>{
    ...
    public int insert(ProductsDTO t) {
        ...
        try {
            ...
            String sql = "INSERT INTO `products`(`productCode`, `productName`, `productPrice`, `productSize`, `productImage`, `groupCode`, `inMenu`, `inSys`)"
                    + "VALUES (?,?,?,?,?,?,?,?)";
    ...
    public int update(ProductsDTO t) {
        ...
        try {
            ...
            String sql = "UPDATE products "
                    + "SET productCode=?,productName=?,productPrice=?,productSize=?,productImage=?,groupCode=?,inMenu=?,inSys=? " 
