...
public class InfoBox extends JPanel {
    ...
    private JDateChooser _datePicker = new JDateChooser();
...
//    
    public void setType(int type, ArrayList<DutyDTO> duties, StaffDTO staff) {
        ...
        if (type == 3) {
            add(_datePicker);
            _datePicker.getDateEditor().setDate(staff.getBirthday());
            _datePicker.setDateFormatString("yyyy-MM-dd");
        ...
        switch (_type) {
            ...
            case 3 -> {
                ...
                try {
                    ...
                    return sdf.format(_datePicker.getDate());
