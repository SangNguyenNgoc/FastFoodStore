...
//                    list.setSelectedIndex(WIDTH);
        ...
        UIButton searchButton = new UIButton("<html><b>EXPORT</b></html>", UIButton.DARK, UIButton.SMALL, true);
        searchButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JFileChooser a = new JFileChooser();
                a.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
                int result = a.showSaveDialog(leftJPanel);
                if (result == JFileChooser.APPROVE_OPTION) {
                    File selectedFile = a.getSelectedFile();
                    System.out.println(selectedFile);
                    try {
                        _Controller.ExportExcel(selectedFile);
        ...
        EditButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < _InfoList.size(); i++) {
                    ...
                    if (_fields[i].getName().split("_")[1].equals("birthday")) {
                        _InfoList.get(i).setType(InfoBox.DATEPICKER, _Controller.getAllDutyDTOs(), _staff);
                    }
                    if (_fields[i].getName().split("_")[1].equals("id")) {
                        _InfoList.get(i).isEditable(false);
        ...
        UIButton ImportExcelButton = new UIButton("<html><b>Import(.xlsx)</b></html>", UIButton.WARNING);
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                if (row >= 0) {
                    ...
                    String tooltipText = "<html>"
                            ...
                            + "        <h1 style=\"text-align:center;font-size:16pt\"> <b style=\"font-size:18pt;color:#212529\">🆔: </b> " + data[0] + "</h1>\n"
                            + "        <h2 style=\"font-size:14pt\">◾ <b style=\"font-size:20pt;color:#212529\">👨‍:</b> " + data[1] + "</h2>\n"
                            + "        <h3 style=\"font-family:San-serif;font-size:12pt\">◾  <b style=\"font-size:16pt;color:#212529\"> ✉:</b> " + data[2] + "</h3>\n"
                    ...
                    if (a != null) {
                        ...
                        tooltipText += "        <h3 style=\"font-family:San-serif;font-size:12pt\">Account: <b style=\"color:#e03131\">❌</b> This staff doesn't have account </h3>\n";
...
//            isEdit = false;
            ...
            _staff = new StaffDTO(data);
            _Controller.deleteStaffAccount(_staff.getID());
...
//                            t= true;
            ...
            if (!flag && t) {
                _Controller.update(_staff);
                try {
                    _Controller.createStaffAccount(_staff.getID());
                    JOptionPane.showMessageDialog(null, "Created Successfully, Account: " + _staff.getID() + " pass:123");
                } catch (Exception e) {
                    JOptionPane.showInternalInputDialog(null, "Something went wrong!");
