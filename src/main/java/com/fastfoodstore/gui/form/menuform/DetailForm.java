...
public class DetailForm extends JDialog {
    ...
    public DetailForm(JFrame parent, String title, ProductsDTO data) {
        ...
        deleteButton.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                int d = ProductsBUS.delete(product);
                if(d != 0) {
                    showMes();
                    dispose();
                } else {
    ...
    public DetailForm(JFrame parent, String title, GroupDTO data) {
        ...
        deleteButton.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                int d = GroupsBus.deleteGroup(group);
                if(d != 0) {
                    showMes();
                    dispose();
                } else {
    ...
    private void initComponent() {
        ...
        saveButton = new Button("Lưu thay đổi", 100, 30, ProjectUtil.getMyGreenColor());
        saveButton.getTextLabel().setFont(ProjectUtil.getMyFont(12));
        saveButton.setBounds(15, 520, 100, 30);
        
        deleteButton = new Button("Xóa sản phẩm", 100, 30, ProjectUtil.getMyRedColor());
        deleteButton.getTextLabel().setFont(ProjectUtil.getMyFont(12));
        deleteButton.setBounds(125, 520, 100, 30);
        
        closeButton = new Button("Đóng", 100, 30, Color.decode("#333333")); 
        closeButton.getTextLabel().setFont(ProjectUtil.getMyFont(12));
        closeButton.setBounds(235, 520, 100, 30);
